...
ALTER TABLE PRODUCT
DROP COLUMN ProductEXP, ProductMFG, ProductOrigin

ALTER TABLE CONSIGNMENT
DROP COLUMN ConsProductPrice

ALTER TABLE PRODUCT
ADD ProductPriceOrigin FLOAT

SELECT IDENT_CURRENT( 'CATEGORY' )  

exec [dbo].[SP_PRODUCT_SEARCH] 'nho', 0, 10, 0

ALTER TABLE dbo.[USER]
--ADD IsActive TINYINT
--ADD CreateTime SMALLDATETIME
ADD UpdateTime SMALLDATETIME